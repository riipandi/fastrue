extern crate lettre;
// use lettre::transport::smtp::{authentication::Credentials, SmtpTransportBuilder};
...
pub async fn send_email_smtp(
    ...
    //     // let mut mailer = AsyncSmtpTransport::<Tokio1Executor>::relay(&smtp_host)?
    //     //     .credentials(smtp_credentials)
    //     //     .build();

    //     let mut mailer = SmtpTransportBuilder::new((smtp_host, smtp_port))
    //         .unwrap()
    //         .credentials(smtp_credentials)
    //         .smtp_utf8(true)
    //         .build();
    // } else {
    //     let mut mailer = AsyncSmtpTransport::<Tokio1Executor>::builder_dangerous(smtp_host)
    //         .port(smtp_port)
    //         .build();
    // }
